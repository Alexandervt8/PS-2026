...
DESCRIPCIÓN:
Este archivo implementa una API REST desarrollada con Flask para gestionar
reservas hoteleras almacenadas en memoria. Proporciona operaciones CRUD para
listar, consultar, crear, actualizar y eliminar reservas mediante los métodos
HTTP GET, POST, PUT y DELETE.

La API valida los campos obligatorios, el número de huéspedes, los estados
permitidos y el formato y orden de las fechas. Asimismo, devuelve códigos HTTP
y mensajes descriptivos según el resultado de cada solicitud.
===========================================================
"""
